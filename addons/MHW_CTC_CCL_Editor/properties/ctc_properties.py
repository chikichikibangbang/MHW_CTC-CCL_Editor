...
class CTCToolPanelPG(bpy.types.PropertyGroup):
    ...
    hideLastNodeAngleLimit: BoolProperty(
        ...
        description="Hide the last ctc node's angle limit cone. This is because the last node is typically unused and has a dummy rotation value",
        default=True,
