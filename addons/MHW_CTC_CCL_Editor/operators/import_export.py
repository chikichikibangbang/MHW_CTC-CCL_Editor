...
from .ctc_function import importCTCFile, exportCTCFile, importCCLFile, exportCCLFile
...
class ImportMHWCCL(bpy.types.Operator, ImportHelper):
    ...
    mergeChain: StringProperty(
        name="",
        description="Merges the imported ccl objects with an existing ctc collection",
        default="")
